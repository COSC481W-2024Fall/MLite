...
class DeploymentTest < ActiveSupport::TestCase
  ...
  test "should save valid deployment" do
    deployment = Deployment.new(name: "Test Deployment", status: "pending", deployment_link: "https://deployments.example.com/test-deployment", model_id: @model.id)
  ...
  test "should not save deployment without name" do
    deployment = Deployment.new(status: "pending", deployment_link: "https://deployments.example.com/test-deployment", model_id: @model.id)
  ...
  test "should not save deployment without status" do
    deployment = Deployment.new(name: "Test Deployment", deployment_link: "https://deployments.example.com/test-deployment", model_id: @model.id)
  ...
  test "should not save deployment without deployment_link" do
    deployment = Deployment.new(name: "Test Deployment", status: "pending", model_id: @model.id)
